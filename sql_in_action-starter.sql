...
-- INVESTIGATE: Should Williamsburg be crowned the most popular neighbourhood? No, tied with Harlem
...
-- Based on the numbers, location and price are the biggest reason for success. 
